...
setv('m_maxerror', 2e-4)
setv('m_relerror', 1e-2)
...
autotabulate(["t", "<m>"], "relax_m.dat", 0.0001e-15)
autotabulate(["t","m_error"], "relax_error.dat", 0.0001e-15)
autotabulate(["t", "maxtorque"], "relax_torque.dat", 0.0001e-15)
#run(1e-8)
...
#autosave("m", "omf", ["Text"], 1e-12)
# Tabulate net magnetization every 1 ps, similar to OOMMF's mmGraph
autotabulate(["t", "<m>"], "m.dat", 0.00001e-15)
autotabulate(["t", "m_error"], "error.dat", 0.00001e-15)
autotabulate(["t", "maxtorque"], "maxtorque.dat", 0.00001e-15)
