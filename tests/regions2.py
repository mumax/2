...
########################################################################################
radius = 300e-9
# radius of the polygon (m)
thickness = 4e-9
# thickness of the polygon (m)
insulatorThickness = 4e-9
# thickness of the insulator between both polygons (m)
sides = 5
# number of sides of the polygon (unitless)
rotation = 0
# angle of rotation of the polygon (degre)
centerX = radius
# X coordinate of the center of the polygon (m)
centerY = radius
# Y coordinate of the center of the polygon (m)
centerZ = thickness/2
# Z coordinate of the center of the polygon (m)
Nx = 128
# number of cell in x direction (unitless)
Ny = 128
# number of cell in y direction (unitless)
Nz = 5
# number of cell in z direction (unitless)
Sx = 2 * radius
# total size of universe in x direction (m)
Sy = 2 * radius
# total size of universe in y direction (m)
Sz = 3*thickness
# total size of universe in z direction (m)
########################################################################################
##
##
########################################################################################
...
m=[ [[[1]]], [[[0]]], [[[0]]] ]
setarray('m', m)
#MsatValues = {"pentagon1":800e3, "pentagon2":400e3}
