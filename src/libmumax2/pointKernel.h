...
#ifndef _POINTKERNEL_H_
#define _POINTKERNEL_H_
...
/// Initialization of the elements of the charge kernel
/// @param data: float arrray to store the kernel data
/// @param comp: Component of the field (X, Y, Z)
...
__declspec(dllexport) void initPointKernelElementAsync(float **data, 
                                 int comp,
