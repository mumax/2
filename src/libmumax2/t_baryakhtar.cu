...
//					 float* __restrict__ lambda_zy,
//					 float* __restrict__ lambda_zx,
//					 float* __restrict__ lambda_yx,
//					 
//					 float* __restrict__ lambda_e_xx,
//					 float* __restrict__ lambda_e_yy,
//					 float* __restrict__ lambda_e_zz,
//					 float* __restrict__ lambda_e_zy,
//					 float* __restrict__ lambda_e_zx,
//					 float* __restrict__ lambda_e_yx,
//					 
...
//					 const float lambdaMul_zy,
//					 const float lambdaMul_zx,
//					 const float lambdaMul_yx,
//					 
//					 const float lambda_eMul_xx,
//					 const float lambda_eMul_yy,
//					 const float lambda_eMul_zz,
//					 const float lambda_eMul_zy,
//					 const float lambda_eMul_zx,
//					 const float lambda_eMul_yx,
//					 
//					 const int4 size,		
//					 const float3 mstep,
//					 const int3 pbc,
