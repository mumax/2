...
//#cgo LDFLAGS:-L/usr/local/cuda/lib -L/usr/local/cuda/lib64 -L/usr/lib/nvidia/ -L/usr/lib64/nvidia/ -L/usr/lib/nvidia-current/ -L/usr/-LC:/opt/cuda/v4.1/lib/x64 -lcuda -lcudart -L.././libmumax2
//#cgo CFLAGS:-I/usr/local/cuda/include/ -IC:/opt/cuda/v4.1/include -Wno-error
