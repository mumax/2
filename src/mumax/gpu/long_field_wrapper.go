...
func LongFieldAsync(hlf *Array, m *Array, msat0 *Array, msat0T0 *Array, kappa *Array, Tc *Array, Ts *Array, kappaMul float64, msat0Mul float64, msat0T0Mul float64, TcMul float64, TsMul float64, stream Stream) {
