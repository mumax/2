...
type Lang interface {
	...
	WriteFunc(out io.Writer, name string, comment string, argNames []string, argTypes []reflect.Type, returnTypes []reflect.Type) // Write a function wrapper to the source file
}
