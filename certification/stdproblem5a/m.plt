...
set ylabel "M/M_s" 
set ylabel  offset character 0, 0, 0 font "Arial, 16" textcolor lt -1 rotate by -270
set y2label "" 
...
GNUTERM = "wxt"
plot 'm-mumax2.txt' u ($1*1e9):2 w p t "<m_x> mumax2", 'm-mumax2.txt' u ($1*1e9):3 w p t "<m_y> mumax2", 'm-mumax2.txt' u ($1*1e9):4 w p t "<m_z> mumax2", 'm-oommf.txt' u ($1*1e9):2 w l t "<m_x> oommf", 'm-oommf.txt' u ($1*1e9):3 w l t "<m_y> oommf", 'm-oommf.txt' u ($1*1e9):4 w l t "<m_z> oommf"
#    EOF
